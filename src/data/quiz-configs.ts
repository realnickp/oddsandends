...
export const quizConfigs: Record<string, ServiceQuizConfig> = {
  ...
  'basement-finishing': {
    ...
    headline: 'Plan Your Basement Project',
    subtitle: "Tell us about the space and we'll put together a complete estimate",
    steps: [
      {
        id: 'basement-scope',
        question: 'What kind of basement project is this?',
        type: 'single-select',
        options: [
          { label: '🏗️ Finish an unfinished basement', value: 'full-finish' },
          { label: '🔄 Refresh a dated finished basement', value: 'refresh' },
          { label: '🔧 Fix a few things down there', value: 'partial' },
          { label: '🤔 Not sure — want our input', value: 'unsure' },
        ],
      },
      {
        ...
        type: 'multi-select',
        options: [
          { label: '🛋️ Family / media room', value: 'family-room' },
          { label: '💼 Home office', value: 'home-office' },
          { label: '🏋️ Home gym', value: 'gym' },
          { label: '🧸 Playroom', value: 'playroom' },
          { label: '🛏️ Guest space', value: 'guest' },
          { label: '🧺 Laundry / storage / mudroom', value: 'utility' },
          { label: '📦 Other', value: 'other' },
        ],
      },
      {
        id: 'basement-moisture',
        question: 'Any history of water or dampness?',
        type: 'single-select',
        options: [
          { label: '✅ Dry as far as I know', value: 'dry' },
          { label: '💧 Occasionally damp or musty', value: 'damp' },
          { label: '🌊 Has taken on water before', value: 'water' },
          { label: '🤷 Not sure', value: 'unsure' },
        ],
      },
      {
        ...
        type: 'single-select',
        options: [
          { label: '📏 Small (under 400 sq ft)', value: 'small' },
          { label: '📐 Medium (400–800 sq ft)', value: 'medium' },
          { label: '🏠 Large (800+ sq ft)', value: 'large' },
          { label: '🤷 Not sure', value: 'unsure' },
        ],
      },
    ],
