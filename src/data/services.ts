...
export const services: Service[] = [
  {
    ...
    whyChooseUs: 'Odds & Ends has been the go-to TV mounting service in Rockland County for over two decades. We take the time to discuss optimal viewing height and angle before drilling a single hole. We carry a full range of mounting hardware for every wall type found in Rockland County homes, from 1950s plaster to modern drywall. Our work is guaranteed, and we always clean up after ourselves.',
    faqs: [
    ...
    metaTitle: 'TV Mounting | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional TV mounting in Tuxedo & Rockland County, NY. Secure bracket installation, cable management, and all wall types. 20+ years experience. Call today!',
  ...
  },
  {
    ...
    whyChooseUs: 'Odds & Ends has repaired thousands of drywall imperfections across Rockland County. We carry multiple grades of joint compound and texturing tools so we can match virtually any existing wall finish. We personally inspect every repair under angled light before considering the job complete. We also handle the painting to ensure a perfect color match.',
    faqs: [
    ...
    metaTitle: 'Drywall Repair | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional drywall repair in Tuxedo & Rockland County. Holes, cracks, water damage patched seamlessly. 20+ years experience. Free estimates available.',
    ...
    whyChooseUsCards: [
      { title: 'Invisible Repairs', description: 'We inspect every patch under angled light to ensure it blends seamlessly — your wall should look like it was never damaged.' },
  ...
  },
  {
    ...
    metaTitle: 'Door Installation | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional door installation in Tuxedo & Rockland County, NY. Interior and exterior doors, pre-hung and slab. Expert fitting for older homes. Call today!',
  ...
  },
  {
    ...
    whyChooseUs: 'Odds & Ends has repaired fences across every neighborhood in Rockland County. We carry common fence hardware, brackets, and fasteners on our truck so most repairs can be completed in a single visit. We match replacement boards to your existing fence as closely as possible and can stain or paint them to blend in. We always clean up the worksite and haul away old materials.',
    faqs: [
    ...
    metaTitle: 'Fence Repair | Tuxedo & Rockland County, NY',
    metaDescription: 'Fence repair services in Tuxedo & Rockland County, NY. Leaning posts, broken boards, sagging gates fixed fast. Wood, vinyl, and chain-link. Call today!',
  ...
  },
  {
    ...
    metaTitle: 'Deck Repair | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional deck repair in Tuxedo & Rockland County. Board replacement, railing fixes, structural repairs, staining and sealing. 20+ years experience.',
    ...
    altText: 'Freshly refinished wood deck with warm cedar stain surrounded by trees',
    processSteps: [
  ...
  },
  {
    ...
    whyChooseUs: 'Odds & Ends has assembled thousands of furniture pieces across Rockland County. We are familiar with every major furniture brand and their assembly systems. We bring professional tools that make the job go faster and produce better results than the included Allen wrenches. We also haul away all packaging materials so you are left with just the finished product.',
    faqs: [
    ...
    metaTitle: 'Furniture Assembly | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional furniture assembly in Tuxedo & Rockland County. IKEA, Wayfair, and all brands. Fast, sturdy assembly with wall anchoring. Call for a quote!',
  ...
  },
  {
    ...
    whyChooseUs: 'Odds & Ends has installed thousands of light fixtures in homes across Rockland County. We handle the full process: safely disconnecting the old fixture, checking the wiring condition, installing a reinforced junction box if needed, and mounting your new fixture securely. We test every fixture before leaving and cleans up all packaging and old hardware.',
    faqs: [
    ...
    metaTitle: 'Light Fixture Installation | Tuxedo & Rockland, NY',
    metaDescription: 'Light fixture installation in Tuxedo & Rockland County. Chandeliers, pendants, sconces, vanity lights installed safely. 20+ years experience. Call today!',
  ...
  },
  {
    ...
    whyHireHandyman: 'Bathroom work involves plumbing connections, tile cutting, precise fixture mounting, and working in tight spaces where mistakes are costly. A toilet not seated on a good flange will leak into the subfloor. A shower surround without proper waterproofing will grow mold behind the wall. A vanity that\'s not level will never look right. Odds & Ends has 20+ years of experience handling all of these trades in one visit — no juggling a plumber, tile guy, and handyman separately.',
    whyChooseUs: 'Most bathroom projects involve multiple trades — plumbing, tile, flooring, fixtures. We handle all of it, which means fewer scheduling headaches, lower total cost, and one person accountable for the finished result. We inspect flanges before setting toilets, waterproof behind shower tile, test every plumbing connection under full pressure, and leave the bathroom cleaner than we found it.',
    faqs: [
    ...
    metaTitle: 'Bathroom Renovation | Tuxedo & Rockland County, NY',
    ...
    altText: 'Renovated bathroom with navy vanity, marble top, and frameless glass shower',
    processSteps: [
      { title: 'Walk-Through & Plan', description: 'We visit your bathroom, discusses what you want updated, takes measurements, and puts together a clear scope and estimate.' },
    ...
    whyChooseUsCards: [
      { title: 'One Call Does It All', description: 'Toilet, vanity, faucet, tile, flooring, shower fixtures, mirrors, accessories — We handle every aspect of your bathroom update in one project.' },
  ...
  },
  {
    ...
    metaTitle: 'Kitchen Renovation | Tuxedo & Rockland County, NY',
    metaDescription: 'Kitchen renovation in Tuxedo & Rockland County. Cabinets, countertops, backsplash, appliances, flooring, islands, sinks, and faucets. One trusted handyman.',
    ...
    altText: 'Renovated kitchen with white shaker cabinets, brass hardware, and wide-plank oak flooring',
    processSteps: [
      { title: 'Consult & Plan', description: 'We visit your kitchen, discusses your priorities and budget, takes measurements, and creates a clear project plan and estimate.' },
    ...
    whyChooseUsCards: [
      { title: 'Complete Kitchen Capability', description: 'Cabinets, countertops, backsplash, flooring, sinks, faucets, appliances, islands, hardware — Odds & Ends does it all so you have one person to call.' },
  ...
  },
  {
    ...
    shortDescription: 'Basement finishing and refresh projects in Tuxedo & Rockland County. Flooring, walls, ceilings, lighting, trim, storage, and moisture control.',
    heroHeadline: 'Basement Finishing in Tuxedo & Rockland County, NY',
    heroSubheadline: 'Turn the space under your house into the best room in it — planned, built, and finished by one trusted local team.',
    intro: 'Most basements are square footage you already paid for and never use. Between the concrete floor, the exposed joists, and that one hanging bulb, the space under your house quietly becomes a storage problem instead of a family room, a home office, a gym, or a movie den.\n\nOdds & Ends Home Services handles practical basement finishing for small to medium sized spaces: moisture assessment first, then framing and drywall, ceilings, luxury vinyl plank flooring, recessed lighting, trim, paint, built-in storage, and media walls. In the older homes around Tuxedo and Tuxedo Park, that often starts with respecting a stone foundation and managing humidity properly; in Rockland split-levels, it usually means bringing a 1970s lower level into this decade. Either way, one team plans it, builds it, and hands you a finished room — not a construction site.',
    commonProblems: [
      'Unfinished basement that collects storage instead of serving the family',
      'Concrete floors that are cold, dusty, and uninviting',
      'Exposed joists, ductwork, and wiring overhead',
      'Musty smell or damp walls that make the space feel unusable',
      'A 1970s-era finished basement that badly needs an update',
      'No proper lighting — one bulb doing the work of twelve',
      'Wasted space under the stairs and between mechanicals',
      'Nowhere for a home office, gym, playroom, or guest space upstairs'
    ],
    jobExamples: [
      'Finished a basement family room with LVP flooring, drywall, recessed lighting, and a built-in media wall in New City',
      'Converted half an unfinished basement into a home office and gym combo in Suffern',
      'Updated a dated 1970s basement — new ceiling, flooring, trim, and paint — in Pearl River',
      'Built storage systems and a workshop corner around mechanicals in a Stony Point basement',
      'Installed moisture barriers, subfloor, and carpet tiles in a Nanuet lower level',
      'Framed and finished a basement laundry and mudroom area in Nyack',
      'Added closet built-ins and guest-ready finishes to a Haverstraw lower level',
      'Refreshed a wooded-lot basement with humidity control and new finishes near Tuxedo'
    ],
    whyHireHandyman: 'Basement finishing punishes shortcuts more than any other project. Finish over a moisture problem and you’ll be tearing it out in two years. It combines framing, drywall, flooring, trim, lighting, and paint in a space where mechanicals, low headroom, and humidity all have opinions. One experienced team that starts with the moisture question, plans around your furnace and panel, and carries the project from bare concrete to painted trim gets you a room that lasts — without coordinating five different trades yourself.',
    whyChooseUs: 'Odds & Ends approaches every basement moisture-first: we check grading, gutters, and humidity before a single stud goes up, because a beautiful finish over a wet wall is money thrown away. From there, the same hands do the framing, drywall, flooring, lighting, trim, and paint, so the finished space feels like one decision instead of five subcontractors. We build around your mechanicals with proper access panels, and we keep the scope honest — if your project needs an engineer, a plumber, or a full egress window cut, we’ll tell you before we start, not after.',
    faqs: [
      { question: 'Do you finish basements from scratch?', answer: 'Yes — for small to medium sized basements we handle the full sequence: moisture assessment, framing, drywall, ceilings, flooring, lighting swaps on existing circuits, trim, paint, and built-in storage. For major electrical rough-in, plumbing for a new bathroom, or structural changes, we bring in and coordinate with the right licensed specialists.' },
      { question: 'My basement smells musty. Can it still be finished?', answer: 'Usually, but the moisture gets solved first. Often the fix is grading, gutters, sealing, and a properly sized dehumidifier rather than anything exotic. We assess it honestly — if your basement needs waterproofing beyond our scope, we’ll say so before you spend a dollar on finishes.' },
      { question: 'What flooring works best in a basement?', answer: 'Luxury vinyl plank is the workhorse — waterproof, warm underfoot with the right underlayment, and it looks like wood. Carpet tiles work well for gyms and playrooms because a damaged tile swaps out in minutes. We’ll match the floor to how you’ll actually use the room.' },
      { question: 'Do I need a permit to finish my basement?', answer: 'Typically yes — both the Town of Tuxedo and Rockland County towns require permits for basement finishing, and a legal bedroom requires an egress window. We’ll tell you what your project needs up front and handle the process with you.' },
      { question: 'How long does a basement project take?', answer: 'A refresh of an already-finished basement — flooring, paint, trim, lighting — typically runs 3 to 7 working days. A full finish of an open basement usually runs 2 to 4 weeks depending on size and scope.' },
      { question: 'Can you work around my furnace, water heater, and panel?', answer: 'Yes — that’s half the craft of basement work. Mechanicals stay accessible with proper clearances and access panels, and we lay the room out so the utility zone disappears from the living space instead of dominating it.' }
    ],
    relatedServices: ['flooring', 'drywall-repair', 'painting', 'built-ins', 'home-office-setup', 'closet-system-installation'],
    metaTitle: 'Basement Finishing | Tuxedo & Rockland County, NY',
    metaDescription: 'Basement finishing in Tuxedo & Rockland County, NY. Moisture-first planning, flooring, drywall, lighting, trim, and built-ins from one trusted local team.',
    keywords: ['basement finishing Tuxedo NY', 'basement remodel Rockland County', 'finish basement near me', 'basement flooring installation', 'basement renovation NY', 'basement home office'],
    image: '/images/transformations/basement-after.jpg',
    altText: 'Finished basement family room with built-in media wall and recessed lighting',
    processSteps: [
      { title: 'Moisture Check & Plan', description: 'We assess humidity, grading, and any water history first, then measure the space and build a plan around how your family will actually use the room.' },
      { title: 'Frame & Rough Prep', description: 'Walls are framed, insulation placed, and surfaces prepped — always with proper clearance and access around mechanicals and utilities.' },
      { title: 'Build & Finish', description: 'Drywall, ceilings, flooring, lighting, trim, and paint transform the space — installed in the right order so every layer supports the next.' },
      { title: 'Detail & Deliver', description: 'Built-ins and storage go in, transitions are finished, everything is tested and cleaned, and you get a room — not a punch list.' }
    ],
    whyChooseUsCards: [
      { title: 'Moisture-First Planning', description: 'We solve the water and humidity questions before finishing anything — because a beautiful basement over a wet wall is a two-year countdown.' },
      { title: 'One Team, Whole Project', description: 'Framing, drywall, flooring, lighting, trim, paint, and built-ins from the same hands — so the finished room feels like one decision.' },
      { title: 'Built Around Your Mechanicals', description: 'Furnace, panel, and water heater stay accessible with clean access panels — the utility zone disappears without being sealed away.' },
      { title: 'Honest Scope', description: 'If your project needs an engineer, a licensed plumber, or a full egress cut, we tell you before work starts — and bring in the right people.' }
    ]
  },
  {
    slug: 'flooring',
    ...
    heroHeadline: 'Flooring Installation in Tuxedo & Rockland County, NY',
    heroSubheadline: 'Vinyl plank, laminate, engineered hardwood, floor tile — beautiful new floors installed right the first time.',
    intro: 'A new floor transforms an entire room. Odds & Ends Home Services handles complete flooring installation — from tearing out old carpet to laying the final transition strip. We work with all the most popular materials: luxury vinyl plank (LVP), laminate, engineered hardwood, and floor tile.\n\nEvery flooring job starts with proper preparation. We inspect and level the subfloor, install appropriate underlayment, and ensure moisture barriers are in place where needed. Whether you are updating a single bathroom or re-flooring your entire first floor, We bring 20+ years of hands-on experience to every cut and every seam.',
    commonProblems: [
    ...
    whyChooseUs: 'Odds & Ends has installed flooring in hundreds of Rockland County homes. We treat every job — whether a single bathroom or an entire first floor — with the same precision. We prep subfloors properly, use quality adhesives and underlayment, and achieve seamless transitions between rooms and materials.',
    faqs: [
    ...
    metaTitle: 'Flooring Installation | Tuxedo & Rockland, NY',
    ...
    altText: 'Newly installed wide-plank white oak hardwood flooring',
    processSteps: [
  ...
  },
  {
    ...
    heroHeadline: 'Tile Work & Backsplash Installation in Tuxedo & Rockland County, NY',
    heroSubheadline: 'Kitchen backsplashes, shower surrounds, accent walls, floor tile, and grout repair — done with precision.',
    intro: 'Tile work is one of those trades where the difference between professional and amateur is immediately visible. Odds & Ends Home Services handles all types of tile projects — kitchen backsplashes, bathroom shower surrounds, accent walls, floor tile, and full regrouting jobs.\n\nProper tile installation demands careful layout planning, precise cuts, correct thin-set application, and clean grout lines. Failing grout and cracked tiles are more than cosmetic issues — they let water penetrate behind walls and under floors, leading to mold and structural damage. Odds & Ends has been setting tile across Rockland County for over 20 years and treats every project with the same level of care, whether it is a small backsplash repair or a full shower retile.',
    commonProblems: [
    ...
    whyChooseUs: 'Tile is one of our specialties. From full shower retiles to small backsplash installs, every job gets the same meticulous attention — precise cuts, tight grout lines, and proper sealing. We carry a range of grout colors and apply quality sealant to protect against moisture and staining.',
    faqs: [
    ...
    metaTitle: 'Tile Work & Backsplashes | Tuxedo & Rockland, NY',
  ...
  },
  {
    ...
    whyChooseUs: 'Odds & Ends has painted hundreds of rooms across Rockland County, from cozy bedrooms to expansive living areas. We prep every surface thoroughly, use premium paints, and apply proper primer when needed. We cut in by hand for razor-sharp edges and always applies two coats for full, even coverage. We protect your floors and furniture with drop cloths and clean up completely when finished.',
    faqs: [
    ...
    metaTitle: 'Painting | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional painting services in Tuxedo & Rockland County, NY. Interior rooms, trim, doors, accent walls. Clean lines and smooth finishes. Free estimates!',
    ...
    whyChooseUsCards: [
      { title: 'Razor-Sharp Lines', description: 'We cut in by hand along ceilings, trim, and corners for crisp edges — no wavy tape lines or sloppy overlaps.' },
  ...
  },
  {
    ...
    metaTitle: 'Shelving Installation | Tuxedo & Rockland, NY',
  ...
  },
  {
    ...
    heroHeadline: 'Cabinet Refinishing Services in Tuxedo & Rockland County',
    heroSubheadline: 'Give your kitchen or bathroom a fresh look without the cost of full replacement.',
    intro: 'Replacing kitchen or bathroom cabinets is expensive and disruptive. Cabinet refinishing gives you a brand-new look at a fraction of the cost — and Odds & Ends can handle the entire project, keeping your costs down.\n\nOdds & Ends Home Services refinishes cabinets throughout Rockland County. We sand, prime, paint, and stain cabinet doors, drawer fronts, and frames to transform dated or worn cabinets into something that looks and feels new. We also swap out hardware, add soft-close hinges, and repair damaged components. When full cabinet installation is needed, we handle that too — but refinishing is the smart, affordable first option most homeowners should consider.',
    commonProblems: [
    ...
    whyHireHandyman: 'Cabinet refinishing looks easy on YouTube but delivers terrible results when done wrong. Proper prep — degreasing, sanding, priming — is what makes paint adhere and last. Skipping steps leads to peeling, brush marks, and a finish that wears off within months. We handle every step with the patience and precision this job demands, and he works solo so there are no extra labor costs.',
    whyChooseUs: 'Odds & Ends has refinished hundreds of cabinets across Rockland County. Our team is meticulous about surface prep, uses high-quality cabinet-grade paint and finishes, and applies multiple coats for a smooth, durable result. We also handle hardware swaps, soft-close upgrades, and minor repairs to doors and drawers. The result looks like a professional kitchen remodel at a fraction of the price. We also handle full cabinet installation when refinishing is not enough.',
    faqs: [
      ...
      { question: 'How long does cabinet refinishing take?', answer: 'A typical kitchen takes 3 to 5 days including prep, priming, painting, and curing time. We work methodically to ensure a flawless, durable finish.' },
      ...
      { question: 'Do you also install new cabinets?', answer: 'Yes. When refinishing is not enough — for instance, if the cabinet boxes are damaged or the layout needs to change — We handle full cabinet installation as well.' }
    ],
    relatedServices: ['shelving-installation', 'painting', 'door-installation', 'built-ins'],
    metaTitle: 'Cabinet Refinishing | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional cabinet refinishing and painting in Tuxedo & Rockland County, NY. Transform kitchen or bath cabinets — sanding, painting, staining, hardware swaps.',
    ...
    whyChooseUsCards: [
      { title: 'Meticulous Surface Prep', description: 'Degreasing, sanding, and priming are what separate a professional finish from a DIY disaster. We never skip a step.' },
      ...
      { title: 'Solo Operator Savings', description: 'We handle the entire project himself, which means lower labor costs for you compared to a multi-person crew.' },
      { title: 'Installation Available Too', description: 'When refinishing is not enough, We also handle full cabinet installation — stock, semi-custom, IKEA, and RTA systems.' }
    ]
  },
  {
    ...
    metaTitle: 'Picture Hanging | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional picture and art hanging services in Tuxedo & Rockland County, NY. Gallery walls, mirrors, heavy frames hung level and secure. Call today!',
  ...
  },
  {
    ...
    metaTitle: 'Air Filter Replacement | Tuxedo & Rockland, NY',
    metaDescription: 'Professional HVAC air filter replacement in Tuxedo & Rockland County, NY. Improve air quality and system efficiency. Regular schedules available. Call today!',
  ...
  },
  {
    ...
    whyChooseUs: 'Odds & Ends replaces door hardware efficiently across Rockland County. We can swap an entire house worth of doorknobs in a single visit, ensuring consistent style and finish throughout. We adjust strike plates and door jambs as needed so every latch catches perfectly. We also dispose of your old hardware and clean up completely.',
    faqs: [
    ...
    metaTitle: 'Doorknob Replacement | Tuxedo & Rockland County, NY',
  ...
  },
  {
    ...
    metaTitle: 'Curtain & Blind Installation | Tuxedo NY',
    metaDescription: 'Professional curtain rod and blind installation in Tuxedo & Rockland County, NY. Window treatments mounted level and secure. All types and styles. Call today!',
  ...
  },
  {
    ...
    whyChooseUs: 'Odds & Ends has installed ceiling fans in bedrooms, living rooms, porches, and sunrooms across Rockland County. We always verify the electrical box is fan-rated and upgrades it if necessary before mounting. We balance every fan to eliminate wobble, set up all controls, and test the fan on every speed before leaving. Clean, safe, and done right.',
    faqs: [
    ...
    metaTitle: 'Ceiling Fan Installation | Tuxedo & Rockland, NY',
    metaDescription: 'Professional ceiling fan installation and replacement in Tuxedo & Rockland County, NY. Fan-rated boxes, balanced mounting, and remote setup. Call for a quote!',
  ...
  },
  {
    ...
    whyChooseUs: 'Odds & Ends stays current with the latest smart home technology so homeowners in Rockland County do not have to. We install the hardware securely, connects everything to your Wi-Fi, configures the apps, and walks you through how to use your new devices before leaving. We troubleshoot connectivity issues and ensure everything works together seamlessly.',
    faqs: [
    ...
    metaTitle: 'Smart Home Setup | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional smart home device installation in Tuxedo & Rockland County, NY. Thermostats, doorbells, cameras, locks, and more set up and configured. Call today!',
  ...
  },
  {
    ...
    metaTitle: 'Home Office Setup | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional home office setup in Tuxedo & Rockland County, NY. Desk assembly, monitor mounting, cable management, and shelving. Work from home comfortably!',
    ...
    altText: 'Custom home office with built-in oak desk and green cabinetry',
    processSteps: [
  ...
  },
  {
    ...
    metaTitle: 'Closet Organization | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional closet organization system installation in Tuxedo & Rockland County, NY. Modular, IKEA, and custom closet systems installed. Maximize your storage!',
  ...
  },
  {
    ...
    heroHeadline: 'Custom Accent Walls in Tuxedo & Rockland County, NY',
    heroSubheadline: 'Board and batten, shiplap, wainscoting, and more — crafted for your space.',
    intro: 'A well-designed accent wall adds architectural interest, texture, and personality to any room. Whether you want the clean lines of board and batten, the warmth of shiplap, the elegance of wainscoting, or a bold geometric pattern, a custom accent wall creates a focal point that elevates your entire space.\n\nOdds & Ends Home Services designs and installs custom accent walls throughout Rockland County. Our team build board and batten, shiplap, wainscoting, slat walls, and panel molding feature walls. With over 20 years of carpentry experience, we handle every detail from design and layout to precise cutting, installation, caulking, and painting for a finished result that looks like it was always part of the home.',
    commonProblems: [
    ...
    metaTitle: 'Custom Accent Walls | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional custom accent wall installation in Tuxedo & Rockland County, NY. Board and batten, shiplap, wainscoting, and wood features. Transform any room!',
    ...
    altText: 'Deep green board-and-batten accent wall with floating oak console',
    processSteps: [
  ...
  },
  {
    ...
    heroHeadline: 'Wainscoting Installation in Tuxedo & Rockland County',
    heroSubheadline: 'Classic wall paneling that adds elegance, character, and protection to any room.',
    intro: 'Wainscoting is one of the most timeless upgrades you can make to a home. It adds architectural detail, protects walls from everyday wear, and instantly elevates the look of hallways, dining rooms, bathrooms, and staircases. But achieving a professional result requires precise measurements, level installation, and clean finishing work.\n\nOdds & Ends Home Services installs wainscoting throughout Rockland County. We build and install beadboard, shaker-style, raised panel, flat panel, and board-and-batten wainscoting in any room of your home. With over 20 years of carpentry experience, we handle every step from layout and cutting to installation, caulking, and painting for a result that looks like it has always been part of the home.',
    commonProblems: [
    ...
    whyHireHandyman: 'Wainscoting demands precision carpentry. Every panel, rail, and stile needs to be cut to exact measurements and installed perfectly level. Corners, outlets, and transitions around doors require custom cuts. The caulking and painting finish is what separates professional wainscoting from a DIY attempt. We handle the entire process with the patience and skill this detail-oriented work demands.',
    whyChooseUs: 'Odds & Ends has installed wainscoting in homes across Rockland County — from simple beadboard in bathrooms to elaborate raised panel designs in formal dining rooms. We measure meticulously, cut precisely, and finish every joint and seam for a seamless result. We keep crews lean to maintain quality control while keeping costs reasonable.',
    faqs: [
    ...
    metaTitle: 'Wainscoting | Tuxedo & Rockland County, NY',
    ...
    whyChooseUsCards: [
      ...
      { title: 'Solo Operator Savings', description: 'We handle the entire project himself, keeping labor costs low while delivering meticulous, detail-oriented craftsmanship.' }
    ]
  },
  {
    slug: 'built-ins',
    ...
    metaTitle: 'Custom Built-Ins | Tuxedo & Rockland County, NY',
    metaDescription: 'Custom built-in bookcases, shelving, and storage in Tuxedo & Rockland County. Designed and built to fit your space perfectly. Call for a consultation!',
    ...
    altText: 'Custom painted built-in bookcases beside a colonial fireplace',
    processSteps: [
  ...
  },
  {
    ...
    heroHeadline: 'Custom Outdoor Structures in Tuxedo & Rockland County, NY',
    heroSubheadline: 'Pergolas, canopies, sheds, and gazebos — built to last and designed for your space.',
    intro: 'Your backyard should be more than just a lawn. A well-built outdoor structure transforms unused yard space into a functional extension of your home — whether it is a pergola for shaded dining, a gazebo for relaxing, a canopy over your patio, or a shed for storage and workshop space.\n\nOdds & Ends Home Services designs and builds custom outdoor structures throughout Rockland County. Our team handles everything from ground preparation and footings to framing, roofing, and finishing. With over 20 years of experience building in Rockland County backyards, we know how to work with local terrain, drainage patterns, and weather conditions to create structures that look great and stand up to New York seasons.',
    commonProblems: [
    ...
    whyChooseUs: 'Odds & Ends has built pergolas, gazebos, sheds, and canopies across Rockland County for over 20 years. We work with you on design and placement, considering sun angles, drainage, and how you actually want to use the space. We use quality lumber, stainless steel hardware, and proper construction techniques. Every structure we build is level, plumb, square, and built to handle whatever Rockland County weather throws at it.',
    faqs: [
    ...
    metaTitle: 'Outdoor Structures | Tuxedo & Rockland County, NY',
    metaDescription: 'Custom pergolas, canopies, sheds, and gazebos in Tuxedo & Rockland County. Built to last with quality materials. 20+ years experience. Free estimates!',
  ...
  },
  {
    ...
    metaTitle: 'Excavation | Tuxedo & Rockland County, NY',
    metaDescription: 'Professional residential excavation in Tuxedo & Rockland County, NY. Trenching, grading, drainage, and site prep. 25+ years experience. Call Odds & Ends today!',
  ...
  },
  {
    ...
    metaTitle: 'Gravel Pad Installation | Tuxedo & Rockland, NY',
  ...
  },
  {
    ...
    metaTitle: 'Shed Building & Assembly | Tuxedo & Rockland, NY',
  ...
  },
  {
    ...
    metaTitle: 'Custom Tiki Bars | Tuxedo & Rockland County, NY',
