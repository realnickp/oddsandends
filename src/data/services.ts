...
export const services: Service[] = [
  ...
  },
  {
    ...
    intro: 'A well-designed accent wall adds architectural interest, texture, and personality to any room. Whether you want the clean lines of board and batten, the warmth of shiplap, the elegance of wainscoting, or a bold geometric pattern, a custom accent wall creates a focal point that elevates your entire space.\n\nOdds & Ends Handyman Service designs and installs custom accent walls throughout Rockland County. Our team build board and batten, shiplap, wainscoting, slat walls, and panel molding feature walls. With over 20 years of carpentry experience, we handle every detail from design and layout to precise cutting, installation, caulking, and painting for a finished result that looks like it was always part of the home.',
    commonProblems: [
  ...
  },
  {
    ...
    intro: 'Your backyard should be more than just a lawn. A well-built outdoor structure transforms unused yard space into a functional extension of your home — whether it is a pergola for shaded dining, a gazebo for relaxing, a canopy over your patio, or a shed for storage and workshop space.\n\nOdds & Ends Handyman Service designs and builds custom outdoor structures throughout Rockland County. Our team handles everything from ground preparation and footings to framing, roofing, and finishing. With over 20 years of experience building in Rockland County backyards, we know how to work with local terrain, drainage patterns, and weather conditions to create structures that look great and stand up to New York seasons.',
    commonProblems: [
