...
export function MobileStickyCTA() {
  ...
  return (
    <>
      {/* Sticky bottom bar */}
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-gray-950 border-t border-gray-800 shadow-2xl" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)', transform: 'translate3d(0,0,0)', WebkitTransform: 'translate3d(0,0,0)' }}>
