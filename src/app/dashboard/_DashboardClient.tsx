      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-sm">
          <div className="mb-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">Odds &amp; Ends Handyman Service</p>
          </div>
      ...
      <div className="flex h-screen bg-gray-50">
        ...
        <aside className="hidden w-60 flex-col bg-gray-900 text-white md:flex">
          ...
          <div className="flex h-16 items-center gap-2.5 border-b border-white/10 px-5">
            ...
            <span className="text-sm font-semibold tracking-tight">Odds &amp; Ends</span>
          </div>
        ...
        <nav className="fixed inset-x-0 bottom-0 z-50 flex items-center justify-around border-t border-gray-200 bg-white md:hidden" style={{ height: 'calc(4rem + env(safe-area-inset-bottom, 0px))', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
          {navItems.map((item) => {
            const Icon = item.icon
            const active = isActive(item.href)
            return (
