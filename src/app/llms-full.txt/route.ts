...
export async function GET() {
  ...
  push(`> Home improvement and handyman services in Tuxedo, Tuxedo Park, and ${siteConfig.county}, ${siteConfig.state} — kitchens, bathrooms, basements, custom built-ins, and more. ${siteConfig.yearsExperience}+ years of experience. Owner-operated, licensed (#${siteConfig.license.number}, ${siteConfig.license.issuedBy}), and insured (${siteConfig.insurance.coverage} ${siteConfig.insurance.type}).`)
  push()
  ...
  push(`- Service area: the Town of Tuxedo, NY (including Tuxedo Park, Eagle Valley, Southfields, Sterling Forest, and Arden) plus all of Rockland County, NY`)
  ...
  push(`- [Services Directory](${siteConfig.url}/services): Kitchens, bathrooms, basements, accent walls, built-ins, decks, flooring, home offices, and all ${services.length} services`)
