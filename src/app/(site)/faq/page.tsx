...
export async function generateMetadata() {
  return generatePageMetadata({
    ...
    description: `Get answers to common questions about Odds & Ends Handyman Service in Tuxedo & Rockland County, NY. Learn about services, pricing, scheduling, service areas, and more.`,
    path: '/faq',
