...
export async function generateMetadata() {
  return generatePageMetadata({
    title: 'Odds & Ends Home Services | Tuxedo, NY Kitchens, Baths & Repairs',
