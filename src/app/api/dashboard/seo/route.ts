...
const BASE_URL = 'https://www.oddsandendsny.com'
...
const staticPages = [
  { path: '/', pageType: 'static' as const, title: 'Home', metaTitle: 'Odds & Ends Handyman Service | Tuxedo & Rockland, NY', metaDescription: 'Kitchens, bathrooms, basements, built-ins, and expert handyman work in Tuxedo, Tuxedo Park & Rockland County, NY. Free estimates.', ogImage: '/images/og-default.jpg', keywords: ['handyman Rockland County', 'home repair services NY', 'Odds & Ends Handyman Service'] },
  { path: '/about', pageType: 'static' as const, title: 'About', metaTitle: 'About Odds & Ends Handyman Service | Tuxedo, NY', metaDescription: 'Meet the Odds & Ends Handyman Service team. Over two decades of trusted craftsmanship, now focused on Tuxedo, Tuxedo Park & Rockland County, NY.', ogImage: '/images/og-default.jpg', keywords: ['about Odds & Ends', 'Odds & Ends handyman', 'Rockland County handyman', 'home repair professional'] },
  { path: '/contact', pageType: 'static' as const, title: 'Contact', metaTitle: 'Contact Odds & Ends Handyman Service | Tuxedo, NY', metaDescription: 'Contact Odds & Ends Handyman Service in Tuxedo & Rockland County, NY. Call, text, or email for a free estimate. We respond quickly to every inquiry.', ogImage: '/images/og-default.jpg', keywords: ['contact handyman', 'Rockland County handyman phone', 'free estimate handyman'] },
  { path: '/estimate', pageType: 'static' as const, title: 'Free Estimate', metaTitle: 'Free Estimate | Odds & Ends Handyman Service, Tuxedo NY', metaDescription: 'Request a free, no-obligation estimate from Odds & Ends Handyman Service. Describe your project and we\'ll get back to you with an honest quote.', ogImage: '/images/og-default.jpg', keywords: ['free estimate', 'handyman quote Rockland County', 'home repair estimate NY'] },
  { path: '/services', pageType: 'static' as const, title: 'All Services', metaTitle: 'Home Services in Tuxedo & Rockland County, NY | O & E', metaDescription: 'Kitchens, bathrooms, basements, accent walls, built-ins, decks, flooring, home offices, and handyman services in Tuxedo & Rockland County, NY.', ogImage: '/images/og-default.jpg', keywords: ['handyman services', 'Rockland County home repair', 'home improvement services NY'] },
  { path: '/areas', pageType: 'static' as const, title: 'Service Areas', metaTitle: 'Service Areas | Tuxedo, Tuxedo Park & Rockland County, NY', metaDescription: 'Odds & Ends Handyman Service proudly serves Tuxedo, Tuxedo Park, and all of Rockland County — Sloatsburg, Suffern, Nyack, New City, and more.', ogImage: '/images/og-default.jpg', keywords: ['home services Tuxedo NY', 'Tuxedo Park contractor', 'Rockland County handyman', 'handyman service areas'] },
  { path: '/blog', pageType: 'static' as const, title: 'Blog', metaTitle: 'Home Improvement Blog | Odds & Ends Handyman Guide', metaDescription: 'Home improvement tips, repair guides, and local advice from a trusted Tuxedo & Rockland County, NY home services pro with 20+ years of experience.', ogImage: '/images/og-default.jpg', keywords: ['home improvement blog', 'handyman tips Rockland County', 'home repair guides NY'] },
  { path: '/faq', pageType: 'static' as const, title: 'FAQ', metaTitle: 'Handyman FAQ | Odds & Ends Service Questions Answered', metaDescription: 'Get answers to common questions about Odds & Ends Handyman Service in Tuxedo & Rockland County, NY. Pricing, scheduling, service areas, and what to expect.', ogImage: '/images/og-default.jpg', keywords: ['handyman FAQ', 'home repair questions', 'Odds & Ends Handyman FAQ'] },
  { path: '/reviews', pageType: 'static' as const, title: 'Reviews', metaTitle: 'Customer Reviews | Odds & Ends Handyman Service', metaDescription: 'Read five-star reviews for Odds & Ends Handyman Service. Trusted by Hudson Valley homeowners for two decades of quality work — now focused on Tuxedo, NY.', ogImage: '/images/og-default.jpg', keywords: ['handyman reviews', 'customer testimonials', 'Odds & Ends reviews Rockland'] },
]
