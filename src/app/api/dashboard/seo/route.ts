...
const staticPages = [
  ...
  { path: '/gallery', pageType: 'static' as const, title: 'Gallery', metaTitle: 'Project Gallery', metaDescription: 'Browse photos of completed handyman projects by Odds & Ends in Rockland County.', ogImage: '/images/og-default.jpg', keywords: ['handyman gallery', 'project photos'] },
