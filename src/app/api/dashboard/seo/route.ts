...
const staticPages = [
  { path: '/', pageType: 'static' as const, title: 'Home', metaTitle: 'Odds & Ends Home Services | Tuxedo, NY Kitchens, Baths & Repairs', metaDescription: 'Kitchens, bathrooms, basements, built-ins, and expert handyman work in Tuxedo, Tuxedo Park & Rockland County, NY. Free estimates.', ogImage: '/images/og-default.jpg', keywords: ['handyman Rockland County', 'home repair services NY', 'Odds & Ends Home Services'] },
  { path: '/about', pageType: 'static' as const, title: 'About', metaTitle: 'About Odds & Ends Home Services | Tuxedo, NY', metaDescription: 'Meet the Odds & Ends Home Services team. Over two decades of trusted craftsmanship, now focused on Tuxedo, Tuxedo Park & Rockland County, NY.', ogImage: '/images/og-default.jpg', keywords: ['about Odds & Ends', 'Odds & Ends handyman', 'Rockland County handyman', 'home repair professional'] },
  { path: '/contact', pageType: 'static' as const, title: 'Contact', metaTitle: 'Contact Odds & Ends Home Services | Tuxedo, NY', metaDescription: 'Contact Odds & Ends Home Services in Tuxedo & Rockland County, NY. Call, text, or email for a free estimate. We respond quickly to every inquiry.', ogImage: '/images/og-default.jpg', keywords: ['contact handyman', 'Rockland County handyman phone', 'free estimate handyman'] },
  { path: '/estimate', pageType: 'static' as const, title: 'Free Estimate', metaTitle: 'Free Estimate | Odds & Ends Home Services, Tuxedo NY', metaDescription: 'Request a free, no-obligation estimate from Odds & Ends Home Services. Describe your project and we\'ll get back to you with an honest quote.', ogImage: '/images/og-default.jpg', keywords: ['free estimate', 'handyman quote Rockland County', 'home repair estimate NY'] },
  ...
  { path: '/faq', pageType: 'static' as const, title: 'FAQ', metaTitle: 'Handyman FAQ | Odds & Ends Service Questions Answered', metaDescription: 'Get answers to common questions about Odds & Ends Home Services in Tuxedo & Rockland County, NY. Pricing, scheduling, service areas, and what to expect.', ogImage: '/images/og-default.jpg', keywords: ['handyman FAQ', 'home repair questions', 'Odds & Ends Handyman FAQ'] },
  { path: '/reviews', pageType: 'static' as const, title: 'Reviews', metaTitle: 'Customer Reviews | Odds & Ends Home Services', metaDescription: 'Read five-star reviews for Odds & Ends Home Services. Trusted by Hudson Valley homeowners for two decades of quality work — now focused on Tuxedo, NY.', ogImage: '/images/og-default.jpg', keywords: ['handyman reviews', 'customer testimonials', 'Odds & Ends reviews Rockland'] },
]
