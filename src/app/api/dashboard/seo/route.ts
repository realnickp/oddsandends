...
const staticPages = [
  ...
  { path: '/about', pageType: 'static' as const, title: 'About', metaTitle: 'About Odds & Ends Handyman | Rockland County, NY Pro', metaDescription: 'Meet the Odds & Ends Handyman Service team. Over 25 years of trusted handyman craftsmanship in Rockland County, NY. Honest pricing and quality work.', ogImage: '/images/og-default.jpg', keywords: ['about Odds & Ends', 'Odds & Ends handyman', 'Rockland County handyman', 'home repair professional'] },
  { path: '/contact', pageType: 'static' as const, title: 'Contact', metaTitle: 'Contact Odds & Ends Handyman Service in Rockland, NY', metaDescription: 'Contact Odds & Ends Handyman Service in Rockland County, NY. Call, text, or email for a free estimate. We respond quickly to every inquiry.', ogImage: '/images/og-default.jpg', keywords: ['contact handyman', 'Rockland County handyman phone', 'free estimate handyman'] },
  { path: '/estimate', pageType: 'static' as const, title: 'Free Estimate', metaTitle: 'Free Handyman Estimate | Odds & Ends Rockland County', metaDescription: 'Request a free, no-obligation estimate from Odds & Ends Handyman Service. Describe your project and we\'ll get back to you with an honest quote.', ogImage: '/images/og-default.jpg', keywords: ['free estimate', 'handyman quote Rockland County', 'home repair estimate NY'] },
